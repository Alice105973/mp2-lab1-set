...
TEST(TBitField, MYTEST_can_compare_non_equal_bitfields_1)
{
  const int size = 4;
  TBitField bf1(size), bf2(size);
...
TEST(TBitField, MYTEST_can_compare_equal_bitfields)
{
  const int size = 4;
  TBitField bf1(size), bf2(size);
...
TEST(TBitField, MYTEST_can_compare_non_equal_bitfields)
{
  const int size = 4;
  TBitField bf1(size), bf2(size);
